    ...
    def test_interactive_dialog_constructs_after_gimp_ui_init(self, tmp_path):
        ...
        script_path.write_text(
            "\n".join((
                ...
                "dialog = ComfyUIGenerationDialog(None, generation_mode='Image Edit')",
    ...
    def test_model_family_controls_workflows_fields_and_resource_guesses(self, tmp_path):
        ...
        script_path.write_text(
            "\n".join((
                ...
                "dialog = ComfyUIGenerationDialog(None, generation_mode='Text to Image')",
                ...
                "assert dialog.workflow_selector.get_active_id().endswith('flux-text-to-image-api.json')",
                ...
                "assert dialog.workflow_selector.get_active_id().endswith('sdxl-text-to-image-api.json')",
                "assert dialog.steps.get_value_as_int() == 30",
                "dialog.destroy()",
